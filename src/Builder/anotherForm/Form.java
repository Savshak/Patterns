...
public class Form {
    ...
    public static void main(String[] args) {
        Form form = new Form.FormBuilder("Dave", "Carter",
                "DavCarter", "DAvCaEr123")
                .passwordHint("MyName")
                .city("NY")
                .language("English")
                .language("Eng")
                .email("savshak@outlook.com")
                .build();
...
/*
Sometimes there is an object with a long list
of properties, and most of these properties are optional
 */